...
//					BASE64Encoder encode = new BASE64Encoder();
					param1 = Base64.encode(path.getBytes(this.code));
...
//				BASE64Encoder encode_aspx = new BASE64Encoder();
				try {
					//文件内容解码是utf－8，发送请求只能是gb2312 才不乱码， 问题标注＝＝＝＝＝＝＝＝＝＝＝＝
				  param2 = Base64.encode(data.getBytes("GB2312"));
...
//					BASE64Encoder encode = new BASE64Encoder();
					param2 = Base64.encode(data.getBytes(this.code));
					param2 = URLEncoder.encode(param2);
				} else {
					param2 = URLEncoder.encode(data, this.code);
				}
...
//				BASE64Encoder encode_aspx = new BASE64Encoder();
				try {
					//文件内容解码是utf－8，发送请求只能是gb2312 才不乱码， 问题标注＝＝＝＝＝＝＝＝＝＝＝＝
				  param3 = Base64.encode(path.getBytes(this.code));
