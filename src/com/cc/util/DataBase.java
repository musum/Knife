...
//					BASE64Encoder encode = new BASE64Encoder();
					...
					payload = Base64.encode(Safe.PHP_DB_MYSQL.getBytes(code));
...
//					BASE64Encoder encode = new BASE64Encoder();
					...
					dbsql = Base64.encode(sql.getBytes(code));
...
//				BASE64Encoder encode = new BASE64Encoder();
				...
				p1 = Base64.encode(p1.getBytes(code));
				p1 = URLEncoder.encode(p1);
				sql = Base64.encode(sql.getBytes(code));
				sql = URLEncoder.encode(sql);
